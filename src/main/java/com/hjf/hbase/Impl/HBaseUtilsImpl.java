...
public class HBaseUtilsImpl{
    ...
    private static final String ZK_CONNECT_VALUE = "node02:2181,node03:2181,node04:2181";
...
//         String[] remove = {"cf1","cf2"};
        ...
        // 添加指定列簇
//         HColumnDescriptor hc = new HColumnDescriptor("sex");
//         hbu.modifyTable("people",hc);
        // hbu.getAllTables();
